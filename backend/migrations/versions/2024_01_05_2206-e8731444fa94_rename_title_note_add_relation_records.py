"""rename title-note, add relation records

Revision ID: e8731444fa94
Revises: dedd9fa9fd6a
Create Date: 2024-01-05 22:06:38.399579
...
def upgrade() -> None:
    ...
    op.add_column(
        "records", sa.Column("note", sa.String(length=256), nullable=False)
    )
    op.add_column(
